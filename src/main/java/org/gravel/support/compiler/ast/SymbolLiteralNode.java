...
public class SymbolLiteralNode extends LiteralNode implements Cloneable {
	...
	public static class SymbolLiteralNode_Factory extends LiteralNode_Factory {
		...
		public SymbolLiteralNode value_(final org.gravel.core.Symbol _aSymbol) {
			return ((SymbolLiteralNode) this.basicNew().initializeValue_(_aSymbol));
		}
	}

	static public SymbolLiteralNode _value_(Object receiver, final org.gravel.core.Symbol _aSymbol) {
	...
	@Override
	public SymbolLiteralNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public SymbolLiteralNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public boolean equals(final Object _anObject) {
		...
		if (this._value == null) {
			...
			if (!org.gravel.support.jvm.ObjectExtensions.equals_(this._value, ((SymbolLiteralNode) _anObject)._value)) {
				return false;
			}
		}
		return true;
	...
	public SymbolLiteralNode initializeValue_(final org.gravel.core.Symbol _aSymbol) {
		_value = _aSymbol;
		this.initialize();
		return this;
	}
	...
	@Override
	public SymbolLiteralNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}
	...
	@Override
	public org.gravel.core.Symbol value() {
		return _value;
	}

	@Override
	public SymbolLiteralNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public SymbolLiteralNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);

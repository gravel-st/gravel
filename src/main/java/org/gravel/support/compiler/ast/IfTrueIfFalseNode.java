...
public class IfTrueIfFalseNode extends IntermediateNode implements Cloneable {
	...
	@Override
	public IfTrueIfFalseNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public IfTrueIfFalseNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	@Override
	public IfTrueIfFalseNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}

	@Override
	public IfTrueIfFalseNode nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	public Expression unoptimized() {
		return KeywordMessageNode.factory.receiver_selector_arguments_(_test, "ifTrue:ifFalse:", org.gravel.support.jvm.ArrayFactory.with_with_(BlockNode.factory.body_(_trueSequence), BlockNode.factory.body_(_falseSequence)));
	}

	@Override
	public IfTrueIfFalseNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public IfTrueIfFalseNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);

...
abstract public class ClassDescriptionNode extends Node implements Cloneable {
	...
	public abstract Diff diffFromClassNode_(final ClassNode _aClassNode);

	public abstract Diff diffFromMetaclassNode_(final MetaclassNode _aMetaclassNode);

	public Diff diffToClassDescriptionNode_(final ClassDescriptionNode _aClassDescriptionNode) {
		final Diff[] _diff;
		...
		org.gravel.support.jvm.ArrayExtensions.syncWith(_instVars, _aClassDescriptionNode.instVars(), new org.gravel.support.jvm.Predicate2<VariableDeclarationNode, VariableDeclarationNode>() {
			...
			public Object value_value_(final VariableDeclarationNode _a, final VariableDeclarationNode _b) {
				return _diff[0] = _diff[0].withDiff_(_a.diffTo_reference_(_b, _reference));
			}
			...
			public Object value_(final VariableDeclarationNode _instVar) {
				return _diff[0] = _diff[0].withDiff_(AddInstVarDiff.factory.reference_instVar_(ClassDescriptionNode.this.reference(), _instVar));
			}
		}, new org.gravel.support.jvm.Block1<Object, VariableDeclarationNode>() {

			@Override
			public Object value_(final VariableDeclarationNode _instVar) {
				return _diff[0] = _diff[0].withDiff_(RemoveInstVarDiff.factory.reference_instVar_(ClassDescriptionNode.this.reference(), _instVar));
			}
		});
		org.gravel.support.jvm.ArrayExtensions.syncWith(_methods, _aClassDescriptionNode.methods(), new org.gravel.support.jvm.Predicate2<MethodNode, MethodNode>() {
			...
			public Object value_(final MethodNode _methodNode) {
				return _diff[0] = _diff[0].withDiff_(AddMethodDiff.factory.reference_methodNode_(ClassDescriptionNode.this.reference(), _methodNode));
			}
		}, new org.gravel.support.jvm.Block1<Object, MethodNode>() {

			@Override
			public Object value_(final MethodNode _methodNode) {
				return _diff[0] = _diff[0].withDiff_(RemoveMethodDiff.factory.reference_methodNode_(ClassDescriptionNode.this.reference(), _methodNode));
			}
		});
		return _diff[0];
	}

	public abstract Diff diffTo_(final ClassDescriptionNode _aClassDescriptionNode);

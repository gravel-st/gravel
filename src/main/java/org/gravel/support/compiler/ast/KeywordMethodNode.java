...
public class KeywordMethodNode extends MethodNode implements Cloneable {
	...
	@Override
	public KeywordMethodNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public KeywordMethodNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public KeywordMethodNode argumentsDo_(final org.gravel.support.jvm.Block1<Object, VariableDeclarationNode> _aBlock) {
	...
	public boolean equals(final Object _anObject) {
		...
		if (this._arguments == null) {
			...
			if (!org.gravel.support.jvm.ArrayExtensions.equals_(this._arguments, ((KeywordMethodNode) _anObject)._arguments)) {
				return false;
			}
		}
		return true;
	...
	public boolean hasCompleteArgumentSignature() {
		return org.gravel.support.jvm.ArrayExtensions.allSatisfy_(_arguments, new org.gravel.support.jvm.Predicate1<VariableDeclarationNode>() {
	...
	@Override
	public KeywordMethodNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}

	@Override
	public KeywordMethodNode nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public KeywordMethodNode typeDefsDo_(final org.gravel.support.jvm.Block1<Object, TypeNode> _aBlock) {
	...
	@Override
	public KeywordMethodNode updatePragmas_(final org.gravel.support.jvm.Block1<PragmaNode, PragmaNode> _aBlock) {
		return this.withPragmas_(org.gravel.support.jvm.ArrayExtensions.collect_(_pragmas, _aBlock));
	}

	@Override
	public KeywordMethodNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public KeywordMethodNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);
	...
	@Override
	public KeywordMethodNode withPropertyAt_put_(final org.gravel.core.Symbol _aKey, final Expression _aValue) {
		if (org.gravel.support.jvm.ArrayExtensions.anySatisfy_(_pragmas, new org.gravel.support.jvm.Predicate1<PragmaNode>() {
			...
			return KeywordMethodNode.this.updatePragmas_(((org.gravel.support.jvm.Block1<PragmaNode, PragmaNode>) (new org.gravel.support.jvm.Block1<PragmaNode, PragmaNode>() {

...
import org.gravel.support.compiler.ast.DiffVisitor.DiffVisitor_Factory;
...
import org.gravel.support.compiler.ast.NonLocalReturnRewriter;
...
public class SystemMappingUpdater extends DiffVisitor implements Cloneable {
	...
	public Class compileClass_extensionPostfix_isStatic_identityClass_(final ClassDescriptionNode _aClassDescriptionNode, final String _extensionPostfix, final boolean _isStatic, final Class _identityClass) {
		...
		_compiler.extraClassesDo_(new org.gravel.support.jvm.Block1<Object, JVMClass>() {
	...
	public SystemMappingUpdater executeUpdateClassDescriptorDiff_reference_(final UpdateClassDescriptorDiff _anUpdateClassDescriptorDiff, final Reference _aReference) {
		...
		_cm = ((ClassMapping) org.gravel.support.jvm.ArrayExtensions.inject_into_(_anUpdateClassDescriptorDiff.updatedMethodNodes(), _cm, ((org.gravel.support.jvm.Block2<ClassMapping, ClassMapping, MethodNode>) (new org.gravel.support.jvm.Block2<ClassMapping, ClassMapping, MethodNode>() {
		...
		_cm = ((ClassMapping) org.gravel.support.jvm.ArrayExtensions.inject_into_(_anUpdateClassDescriptorDiff.deletedSelectors(), _cm, ((org.gravel.support.jvm.Block2<ClassMapping, ClassMapping, String>) (new org.gravel.support.jvm.Block2<ClassMapping, ClassMapping, String>() {
		...
		_methods = org.gravel.support.jvm.ArrayExtensions.copyWithAll_(_anUpdateClassDescriptorDiff.methodNodes(), _anUpdateClassDescriptorDiff.updatedMethodNodes());
	...
	public SystemMappingUpdater isStaticOverride_while_(final boolean _aBoolean, final org.gravel.support.jvm.Block0<SystemMappingUpdater> _aBlock) {
		final boolean _old;
		if (org.gravel.support.jvm.BooleanExtensions.equals_(_isStaticOverride, (_aBoolean || _isStaticOverride))) {

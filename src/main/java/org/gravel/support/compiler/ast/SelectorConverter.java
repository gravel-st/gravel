...
public class SelectorConverter extends Object implements Cloneable {
	...
	public String functionNameForNumArgs_(final int _numArgs) {
		if (org.gravel.support.jvm.IntegerExtensions.equals_(_numArgs, 0)) {
			return "value";
		}
		return new org.gravel.core.Interval(1, _numArgs).join_(((org.gravel.support.jvm.Block1<String, Integer>) (new org.gravel.support.jvm.Block1<String, Integer>() {

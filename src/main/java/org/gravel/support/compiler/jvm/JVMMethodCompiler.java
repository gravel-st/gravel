...
import org.gravel.support.compiler.ast.NonLocalVariableFinder;
...
public class JVMMethodCompiler extends NodeVisitor<Object> implements Cloneable {
	...
	public JVMMethodCompiler ensureCast_(final JVMType _aType) {
		...
		if (!org.gravel.support.jvm.ObjectExtensions.equals_(_temp1, _aType)) {
	...
	public Frame newFrame_(final org.gravel.support.jvm.Block0<Object> _aBlock) {
		...
		_oldLocals = _locals;
		this.reset();
		_locals = org.gravel.support.jvm.DictionaryExtensions.copy(_oldLocals);
		_aBlock.value();
	...
	public JVMMethodCompiler produceConstant_ifAbsentPut_(final Expression _anExpression, final org.gravel.support.jvm.Block0<Object> _aBlock) {
		final JVMMethodConstant _const;
		_const = _parent.constantAt_ifAbsentPut_(_anExpression, ((org.gravel.support.jvm.Block0<JVMMethodConstant>) (new org.gravel.support.jvm.Block0<JVMMethodConstant>() {
	...
	public JVMMethodCompiler produceMessageSend_(final MessageNode _messageNode) {
		...
		_selector = org.gravel.core.Symbol.value(_messageNode.selector());
	...
	public JVMMethodCompiler produceNonLocalCatchMethod_(final MethodNode _aMethodNode) {
		...
		this.emit_(TryCatch.factory.tryFrame_exception_catchFrame_(this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {

			@Override
			public Object value() {
				return JVMMethodCompiler.this.produceMethodBody_(_aMethodNode.body());
			}
		}), JVMDefinedObjectType.factory.nonLocalReturn(), this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
			...
			public Object value() {
				...
				return JVMMethodCompiler.this.emit_(IfObjectsEqualThenElse.factory.trueFrame_falseFrame_(JVMMethodCompiler.this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
				...
				}), JVMMethodCompiler.this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
	...
	public JVMMethodCompiler producePrimitive_def_(final MethodNode _aMethodNode, final String[] _prim) {
		...
		if (_invoke == null) {
			...
			JVMMethodCompiler.this.emit_(InvokeSpecial.factory.init_voidArguments_(JVMDefinedObjectType.factory.runtimeException(), org.gravel.support.jvm.ArrayFactory.with_(JVMDefinedObjectType.factory.string())));
	...
	public JVMMethodCompiler produceToDoNodeConstantStep_step_(final ToDoNode _toDoNode, final int _step) {
		this.emit_(this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
			...
			public Object value() {
				...
				_incFrame = JVMMethodCompiler.this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
				...
				_testFrame = JVMMethodCompiler.this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
				...
				_doFrame = JVMMethodCompiler.this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
	...
	public JVMMethodCompiler pushFixedPoint_(final java.math.BigDecimal _aFixedPoint) {
		...
		this.emit_(InvokeSpecial.factory.init_voidArguments_(JVMDefinedObjectType.factory.bigDecimal(), org.gravel.support.jvm.ArrayFactory.with_(JVMDefinedObjectType.factory.string())));
		return this;
	}
	...
	public JVMMethodCompiler pushLargeInteger_(final java.math.BigInteger _anInteger) {
		...
		this.emit_(InvokeSpecial.factory.init_voidArguments_(JVMDefinedObjectType.factory.bigInteger(), org.gravel.support.jvm.ArrayFactory.with_(JVMDefinedObjectType.factory.string())));
		return this;
	}
	...
	public JVMMethodCompiler pushSymbol_(final org.gravel.core.Symbol _aSymbol) {
	...
	public JVMMethodCompiler visitArrayLiteralNode_(final ArrayLiteralNode _literalNode) {
		this.produceConstant_ifAbsentPut_(_literalNode, new org.gravel.support.jvm.Block0<Object>() {
	...
	public JVMMethodCompiler visitBooleanAndNode_(final BooleanAndNode _aNode) {
		this.emit_(AndThenElse.factory.left_right_(this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
		...
		}), this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
	...
	public JVMMethodCompiler visitBooleanOrNode_(final BooleanOrNode _aNode) {
		this.emit_(OrThenElse.factory.left_right_(this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
	...
	public JVMMethodCompiler visitCascadeNode_(final CascadeNode _cascadeNode) {
		...
		for (final MessageNode _message : org.gravel.support.jvm.ArrayExtensions.copyWithoutLast(_cascadeNode.messages())) {
			JVMMethodCompiler.this.emit_(Dup.factory.basicNew());
	...
	public JVMMethodCompiler visitIfTrueIfFalseNode_(final IfTrueIfFalseNode _aNode) {
		...
		this.emit_(IfThenElse.factory.trueFrame_falseFrame_(this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
	...
	public JVMMethodCompiler visitIsNilNode_(final IsNilNode _aNode) {
		...
		org.gravel.support.jvm.ObjectExtensions.assert_(this, _stack.peek().isDynamicObjectType());
	...
	public JVMMethodCompiler visitMethodNode_(final MethodNode _aMethodNode) {
		final String[] _prim;
		this.reset();
		_methodName = _parent.selectorConverter().selectorAsFunctionName_(org.gravel.core.Symbol.value(_aMethodNode.selector()));
	...
	public JVMMethodCompiler visitNonLocalReturnNode_(final NonLocalReturnNode _returnNode) {
		org.gravel.support.jvm.ObjectExtensions.assert_(this, _isBlock);
		...
		this.emit_(InvokeSpecial.factory.init_voidArguments_(JVMDefinedObjectType.factory.nonLocalReturn(), org.gravel.support.jvm.ArrayFactory.with_with_(JVMDynamicObjectType.factory.basicNew(), JVMDefinedObjectType.factory.object())));
	...
	public JVMMethodCompiler visitWhileFalseNode_(final WhileFalseNode _aNode) {
		this.emit_(WhileFalseLoop.factory.testFrame_doFrame_(this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {
	...
	public JVMMethodCompiler visitWhileTrueNode_(final WhileTrueNode _aNode) {
		this.emit_(WhileTrueLoop.factory.testFrame_doFrame_(this.newFrame_(new org.gravel.support.jvm.Block0<Object>() {

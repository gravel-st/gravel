...
public class UnaryMessageNode extends MessageNode implements Cloneable {
	...
	@Override
	public UnaryMessageNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public UnaryMessageNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public boolean isTraitRequirementMessage() {
		return _receiver.isSelfNode() && org.gravel.support.jvm.StringExtensions.equals_(_selector, "traitRequirement");
	}

	@Override
	public UnaryMessageNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}

	@Override
	public UnaryMessageNode nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public UnaryMessageNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public UnaryMessageNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);
	...
	public UnaryMessageNode withArguments_(final Expression[] _anArray) {
		org.gravel.support.jvm.ObjectExtensions.assert_(this, _anArray.length == 0);
		return this;
	}

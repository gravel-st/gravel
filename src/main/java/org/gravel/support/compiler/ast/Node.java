...
import org.gravel.support.compiler.ast.SourcePointerRemover;
...
abstract public class Node extends Object implements Cloneable {
	...
	public static class Node_Factory extends org.gravel.support.jvm.SmalltalkFactory {
	...
	public java.util.Set<String> allLocalVarNames() {
		...
		this.withAllNodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
			...
			public Object value_(final Node _n) {
				return _n.localVarNamesDo_(new org.gravel.support.jvm.Block1<Object, String>() {
	...
	public Node allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	public Node allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public boolean equals(final Object _anObject) {
		...
		if (this._sourcePosition == null) {
			...
			if (!org.gravel.support.jvm.ObjectExtensions.equals_(this._sourcePosition, ((Node) _anObject)._sourcePosition)) {
				return false;
			}
		}
		return true;
	...
	public boolean hasSuperSend() {
		return this.allNodesContains_(((org.gravel.support.jvm.Block1<Boolean, Node>) (new org.gravel.support.jvm.Block1<Boolean, Node>() {
	...
	public Node localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}

	public abstract Node nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock);
	...
	public Node withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
		this.allNodesDo_(_aBlock);
		return this;
	}

	public Node withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);

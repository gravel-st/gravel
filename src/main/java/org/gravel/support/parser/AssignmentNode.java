...
public class AssignmentNode extends Expression implements Cloneable {
	...
	@Override
	public AssignmentNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public AssignmentNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public boolean equals(final Object _anObject) {
		...
		if (this._variable == null) {
			...
			if (!org.gravel.support.jvm.ObjectExtensions.equals_(this._variable, ((AssignmentNode) _anObject)._variable)) {
				return false;
			}
		}
		if (this._value == null) {
			...
			if (!org.gravel.support.jvm.ObjectExtensions.equals_(this._value, ((AssignmentNode) _anObject)._value)) {
				return false;
			}
		}
		return true;
	...
	@Override
	public AssignmentNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}

	@Override
	public AssignmentNode nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public AssignmentNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public AssignmentNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);

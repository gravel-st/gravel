...
public class MetaclassNode extends ClassDescriptionNode implements Cloneable {
	...
	@Override
	public Diff diffFromClassNode_(final ClassNode _aClassNode) {
		throw new RuntimeException("Should not occur");
	}

	@Override
	public Diff diffFromMetaclassNode_(final MetaclassNode _aMetaclassNode) {
		return _aMetaclassNode.diffToClassDescriptionNode_(this);
	}

	@Override
	public Diff diffTo_(final ClassDescriptionNode _aClassDescriptionNode) {
		return _aClassDescriptionNode.diffFromMetaclassNode_(this);
	}

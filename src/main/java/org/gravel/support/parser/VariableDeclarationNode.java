...
public class VariableDeclarationNode extends Node implements Cloneable {
	...
	public Diff diffTo_reference_(final VariableDeclarationNode _aVariableDeclarationNode, final Reference _aReference) {
		final Diff _diff;
		_diff = EmptyDiff.factory.basicNew();
		if (!org.gravel.support.jvm.StringExtensions.equals_(_name, _aVariableDeclarationNode.name())) {
			org.gravel.support.jvm.ObjectExtensions.halt(_diff);
		}
		if (!org.gravel.support.jvm.ObjectExtensions.equals_(_type, _aVariableDeclarationNode.type())) {
			org.gravel.support.jvm.ObjectExtensions.halt(_diff);
		}
		return _diff;
	}

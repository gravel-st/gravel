...
abstract public class MethodNode extends Node implements Cloneable {
	...
	@Override
	public MethodNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public MethodNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public Diff diffTo_reference_(final MethodNode _aMethodNode, final Reference _aReference) {
		if (org.gravel.support.jvm.ObjectExtensions.equals_(this, _aMethodNode)) {
			return EmptyDiff.factory.basicNew();
		}
		return UpdateMethodDiff.factory.reference_methodNode_(_aReference, _aMethodNode);
	}
	...
	public boolean equals(final Object _anObject) {
		...
		if (this._selector == null) {
			...
			if (!org.gravel.support.jvm.StringExtensions.equals_(this._selector, ((MethodNode) _anObject)._selector)) {
				return false;
			}
		}
		if (this._returnType == null) {
			...
			if (!org.gravel.support.jvm.ObjectExtensions.equals_(this._returnType, ((MethodNode) _anObject)._returnType)) {
				return false;
			}
		}
		if (this._body == null) {
			...
			if (!org.gravel.support.jvm.ObjectExtensions.equals_(this._body, ((MethodNode) _anObject)._body)) {
				return false;
			}
		}
		if (this._pragmas == null) {
			...
			if (!org.gravel.support.jvm.ArrayExtensions.equals_(this._pragmas, ((MethodNode) _anObject)._pragmas)) {
				return false;
			}
		}
		if (this._protocol == null) {
			...
			if (!org.gravel.support.jvm.StringExtensions.equals_(this._protocol, ((MethodNode) _anObject)._protocol)) {
				return false;
			}
		}
		if (this._nlrMarker == null) {
			...
			if (!org.gravel.support.jvm.StringExtensions.equals_(this._nlrMarker, ((MethodNode) _anObject)._nlrMarker)) {
				return false;
			}
		}
		return true;
	...
	public boolean hasNonLocalReturns() {
		...
		try {
			for (final Statement _rootStmt : _body.statements()) {
				_rootStmt.allNodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public boolean isTraitRequirement() {
		return org.gravel.support.jvm.IntegerExtensions.equals_(_body.statements().length, 1) && _body.statements()[0].isTraitRequirementMessage();
	}
	...
	public String[] localPrimitiveIn_nameNode_(final String _className, final StringLiteralNode _argument) {
		return org.gravel.support.jvm.ArrayFactory.with_with_(_className, _argument.value());
	}

	@Override
	public MethodNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}
	...
	@Override
	public abstract MethodNode nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock);
	...
	public Object pragmaPropertyAt_ifAbsent_(final org.gravel.core.Symbol _aKey, final org.gravel.support.jvm.Block0<Object> _aBlock) {
		final Object _temp1 = new Object();
		try {
			final PragmaNode _pr;
			_pr = ((PragmaNode) org.gravel.support.jvm.ArrayExtensions.detect_ifNone_(_pragmas, new org.gravel.support.jvm.Predicate1<PragmaNode>() {

				@Override
				public boolean value_(final PragmaNode _each) {
					return _each.isPropertyPragmaAt_(_aKey);
				}
			}, ((org.gravel.support.jvm.Block0<PragmaNode>) (new org.gravel.support.jvm.Block0<PragmaNode>() {
	...
	public String[] primitiveIn_(final String _className) {
		...
		return org.gravel.support.jvm.ArrayExtensions.collect_(_arrayNode.value(), ((org.gravel.support.jvm.Block1<String, Object>) (new org.gravel.support.jvm.Block1<String, Object>() {
	...
	public PragmaNode primitivePragma() {
		return ((PragmaNode) org.gravel.support.jvm.ArrayExtensions.detect_ifNone_(_pragmas, new org.gravel.support.jvm.Predicate1<PragmaNode>() {

			@Override
			public boolean value_(final PragmaNode _e) {
				return org.gravel.support.jvm.StringExtensions.equals_(_e.expression().selector(), "primitive:");
			}
		}, ((org.gravel.support.jvm.Block0<PragmaNode>) (new org.gravel.support.jvm.Block0<PragmaNode>() {
	...
	public abstract MethodNode typeDefsDo_(final org.gravel.support.jvm.Block1<Object, TypeNode> _aBlock);

	public MethodNode updatePragmas_(final org.gravel.support.jvm.Block1<PragmaNode, PragmaNode> _aBlock) {
		return this.withPragmas_(org.gravel.support.jvm.ArrayExtensions.collect_(_pragmas, _aBlock));
	}

	@Override
	public MethodNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public MethodNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);
	...
	public MethodNode withPropertyAt_put_(final org.gravel.core.Symbol _aKey, final Expression _aValue) {
		if (org.gravel.support.jvm.ArrayExtensions.anySatisfy_(_pragmas, new org.gravel.support.jvm.Predicate1<PragmaNode>() {
			...
			return MethodNode.this.updatePragmas_(((org.gravel.support.jvm.Block1<PragmaNode, PragmaNode>) (new org.gravel.support.jvm.Block1<PragmaNode, PragmaNode>() {

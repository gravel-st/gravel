...
public class VariableNode extends Expression implements Cloneable {
	...
	public static class VariableNode_Factory extends Expression_Factory {
		...
		public VariableNode name_(final String _aString) {
			org.gravel.support.jvm.ObjectExtensions.deny_(this, org.gravel.support.jvm.StringExtensions.equals_(_aString, "nil"));
	...
	@Override
	public VariableNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public VariableNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public boolean equals(final Object _anObject) {
		...
		if (this._name == null) {
			...
			if (!org.gravel.support.jvm.StringExtensions.equals_(this._name, ((VariableNode) _anObject)._name)) {
				return false;
			}
		}
		return true;
	...
	public boolean isSelfNode() {
		return org.gravel.support.jvm.StringExtensions.equals_(_name, "self");
	}

	@Override
	public boolean isSuperNode() {
		return org.gravel.support.jvm.StringExtensions.equals_(_name, "super");
	}
	...
	@Override
	public VariableNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
	...
	@Override
	public VariableNode nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		return this;
	}
	...
	@Override
	public VariableNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public VariableNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);

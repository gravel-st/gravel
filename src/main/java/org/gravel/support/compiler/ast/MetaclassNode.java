...
import org.gravel.support.compiler.ast.ClassReference;
...
public class MetaclassNode extends ClassDescriptionNode implements Cloneable {
	...
	@Override
	public MetaclassNode allMethodsIn_do_(final SystemNode _aSystemNode, final org.gravel.support.jvm.Block1<Object, MethodNode> _aBlock) {
	...
	@Override
	public MetaclassNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public MetaclassNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	@Override
	public MetaclassNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}
	...
	@Override
	public MetaclassNode nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		for (final MethodNode _temp1 : _methods) {
			_aBlock.value_(_temp1);
		}
	...
	@Override
	public MetaclassNode selectorsDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
	...
	public Reference superclassReferenceForMethodLookup() {
		...
		_csr = _classNode.superclassReference();
		if (_csr == null) {
			return AbsoluteReference.factory.path_(new org.gravel.core.Symbol[] { org.gravel.core.Symbol.value("org"), org.gravel.core.Symbol.value("gravel"), org.gravel.core.Symbol.value("lang"), org.gravel.core.Symbol.value("Class") });
		}
		return ClassReference.factory.reference_(((AbsoluteReference) _csr));
	}

	@Override
	public MetaclassNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public MetaclassNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);
	...
	public MetaclassNode withExtraMethods_(final MethodNode[] _extraMethods) {
		return org.gravel.support.jvm.ArrayExtensions.inject_into_(_extraMethods, this, ((org.gravel.support.jvm.Block2<MetaclassNode, MetaclassNode, MethodNode>) (new org.gravel.support.jvm.Block2<MetaclassNode, MetaclassNode, MethodNode>() {

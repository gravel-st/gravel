...
public class BinaryMessageNode extends MessageNode implements Cloneable {
	...
	@Override
	public BinaryMessageNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public BinaryMessageNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	public boolean equals(final Object _anObject) {
		...
		if (this._argument == null) {
			...
			if (!org.gravel.support.jvm.ObjectExtensions.equals_(this._argument, ((BinaryMessageNode) _anObject)._argument)) {
				return false;
			}
		}
		return true;
	...
	@Override
	public BinaryMessageNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}

	@Override
	public BinaryMessageNode nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public BinaryMessageNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public BinaryMessageNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);
	...
	public BinaryMessageNode withArguments_(final Expression[] _anArray) {
		org.gravel.support.jvm.ObjectExtensions.assert_(this, org.gravel.support.jvm.IntegerExtensions.equals_(_anArray.length, 1));

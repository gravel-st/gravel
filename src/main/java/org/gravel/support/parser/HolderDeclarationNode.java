...
import org.gravel.support.parser.VariableDeclarationNode.VariableDeclarationNode_Factory;
...
public class HolderDeclarationNode extends VariableDeclarationNode implements Cloneable {
	...
	@Override
	public HolderDeclarationNode allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public HolderDeclarationNode allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	@Override
	public HolderDeclarationNode localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
	...
	@Override
	public HolderDeclarationNode typeDefsDo_(final org.gravel.support.jvm.Block1<Object, TypeNode> _aBlock) {
		if (_type != null) {
	...
	@Override
	public HolderDeclarationNode withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public HolderDeclarationNode withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);

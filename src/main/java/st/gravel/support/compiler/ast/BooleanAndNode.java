...
public class BooleanAndNode extends BooleanBinaryNode implements Cloneable {
	...
	@Override
	public BooleanAndNode allNodesDo_(final st.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public BooleanAndNode allNodesDo_pruneWhere_(final st.gravel.support.jvm.Block1<Object, Node> _aBlock, final st.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new st.gravel.support.jvm.Block1<Object, Node>() {
	...
	@Override
	public BooleanAndNode localVarNamesDo_(final st.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}
	...
	@Override
	public BooleanAndNode withAllNodesDo_(final st.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public BooleanAndNode withAllNodesDo_pruneWhere_(final st.gravel.support.jvm.Block1<Object, Node> _aBlock, final st.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);

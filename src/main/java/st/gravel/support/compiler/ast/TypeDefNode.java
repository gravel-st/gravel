...
public class TypeDefNode extends TypeNode implements Cloneable {
	...
	@Override
	public TypeDefNode allNodesDo_(final st.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public TypeDefNode allNodesDo_pruneWhere_(final st.gravel.support.jvm.Block1<Object, Node> _aBlock, final st.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new st.gravel.support.jvm.Block1<Object, Node>() {
	...
	public boolean equals(final Object _anObject) {
		...
		if (this._node == null) {
			...
			if (!st.gravel.support.jvm.ObjectExtensions.equals_(this._node, ((TypeDefNode) _anObject)._node)) {
				return false;
			}
		}
		return true;
	...
	@Override
	public TypeDefNode localVarNamesDo_(final st.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}
	...
	@Override
	public TypeDefNode typeDefsDo_(final st.gravel.support.jvm.Block1<Object, TypeNode> _aBlock) {
		_aBlock.value_(_node);
		return this;
	}

	@Override
	public TypeDefNode withAllNodesDo_(final st.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public TypeDefNode withAllNodesDo_pruneWhere_(final st.gravel.support.jvm.Block1<Object, Node> _aBlock, final st.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);

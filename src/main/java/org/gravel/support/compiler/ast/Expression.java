...
abstract public class Expression extends Statement implements Cloneable {
	...
	@Override
	public Expression allNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
	...
	@Override
	public Expression allNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		this.nodesDo_(new org.gravel.support.jvm.Block1<Object, Node>() {
	...
	@Override
	public Expression localVarNamesDo_(final org.gravel.support.jvm.Block1<Object, String> _aBlock) {
		return this;
	}
	...
	@Override
	public abstract Expression nodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock);
	...
	public Expression send_with_(final String _aSymbol, final Expression _argNode1) {
		return this.send_withAll_(_aSymbol, org.gravel.support.jvm.ArrayFactory.with_(_argNode1));
	}

	public Expression send_with_with_(final String _aSymbol, final Expression _argNode1, final Expression _argNode2) {
		return this.send_withAll_(_aSymbol, org.gravel.support.jvm.ArrayFactory.with_with_(_argNode1, _argNode2));
	}
	...
	public Expression send_with_with_with_(final String _aSymbol, final Expression _argNode1, final Expression _argNode2, final Expression _argNode3) {
		return this.send_withAll_(_aSymbol, org.gravel.support.jvm.ArrayFactory.with_with_with_(_argNode1, _argNode2, _argNode3));
	}
	...
	@Override
	public Expression withAllNodesDo_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock) {
		_aBlock.value_(this);
	...
	@Override
	public Expression withAllNodesDo_pruneWhere_(final org.gravel.support.jvm.Block1<Object, Node> _aBlock, final org.gravel.support.jvm.Block1<Boolean, Node> _pruneBlock) {
		_aBlock.value_(this);
